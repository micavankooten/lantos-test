...
(function (jQuery, window, document, undefined) {
  ...
  vid.prototype.init = function () {
    ...
    if (_self._settings.vimeo_url) {
      ...
      _self._video =
        _self._element.find("video")[0] === undefined
          ? _self.createVideoTags()
          : _self._element.find("video");
      _self.buildWrapper();
    }
  ...
  vid.prototype.buildWrapper = function () {
    ...
    _self._video.wrap(
      '<div class="rtopVideoPlayerWrapper"><div class="rtopVideoPlayer ' +
        _self._settings.themeClass +
        (_self._settings.fontAwesomeControlIcons ? " hasFA" : "") +
        '"></div>'
    );
    ...
    _self._video.wrap(
      '<div class="rtopVideoHolder' +
        (_self._settings.fontAwesomeControlIcons ? " hasFAIcons" : "") +
        '"></div>'
    );
    ...
    // set video tag id
    if (!_self._settings.vimeo_url) {
      _self._player = document.getElementById(
        _self._element.find("video").attr("id")
      );
    }
    ...
    if (_self._settings.playInModal && !_self._settings.vimeo_url) {
      jQuery("body").append(
        '<div class="rtopVideoModal" id="' +
          _self._element.find("video").attr("id") +
          '_modal"><div class="videoModalHolder"></div></div>'
      );
      _self._element.append(
        '<div class="rtopVideoPosterImage' +
          (_self._settings.fontAwesomeControlIcons ? " hasFAIcons" : "") +
          '"><img src="' +
          _self._video.attr("poster") +
          '" /></div>'
      );
    }
    ...
    if (_self._settings.showControls) {
      ...
      !_self._settings.showControls &&
      _self._settings.allowPlayPause
    ) {
      _self.playPauseEvents();
    } else if (
      !_self._settings.showControls &&
      !_self._settings.allowPlayPause &&
      _self._settings.autoPlay
    ) {
      if (!_self._settings.vimeo_url) {
        _self.startAutoPlay();
      }
  ...
  vid.prototype.createVideoTags = function () {
    ...
    if (_videoData.video) {
      ...
      console.log(
        "There was an error loading your video, please check documentation --> https://redtettemer.github.io/rtop-video-player/"
      );
      return false;
    }
  };
  ...
  vid.prototype.buildControls = function () {
    ...
    if (_self._settings.showScrubber) {
      ...
      _self._element
        .find(".vidControls")
        .addClass("noProgressBar")
        .prepend('<div id="progressSpacer" class="controlBtn"></div>');
    }
    ...
    if (_self._settings.showPlayPauseBtn) {
      ...
      _self._element
        .find(".vidControls")
        .addClass("noPP")
        .prepend('<div id="playPauseHolder" class="controlBtn"></div>');
    }
  ...
  vid.prototype.addProgressBar = function () {
    ...
    _self._element
      ...
      .append(
        '<div id="progressholder" class="controlBtn"><div id="fullvideoprogress"></div><div id="buffered"></div><div id="progress"></div><div id="progressorb"></div></div>'
      );
  };
  ...
  vid.prototype.addTimer = function () {
    ...
    _self._element
      ...
      .addClass("hasTimer")
      .append(
        '<div id="timeholder" class="controlBtn"><span id="currenttime">00:00</span> / <span id="totaltime">00:00</span></div>'
      );
  };
    ...
    _self._element
      ...
      .append(
        '<div id="soundControl" class="controlBtn"><span class="muteBtn' +
          (_self._settings.fontAwesomeControlIcons ? " FAIcon" : "localAsset") +
          '">' +
          (_self._settings.fontAwesomeControlIcons
  ...
  vid.prototype.clickEvents = function () {
    ...
    _self._playerWrapper.find("#playPause").on("click", function () {
      _self._playerWrapper.hasClass("playing")
        ? _self.pause()
        : _self._playerWrapper.hasClass("finished")
        ? _self._settings.allowReplay
          ? _self.replay()
          : null
        : _self.play();
    });
    ...
    _self._playerWrapper.find("#fullScreenBtn").on("click", function () {
      let click_element = $(this).parent().parent().parent().parent();
      let elemento = click_element.parent().parent().parent().parent().parent();
      let btn_element = $(this).parent().parent();
      if (click_element.hasClass("testimonios")) {
        if (!btn_element.hasClass("isFullscreen")) {
          elemento.parent().parent().removeClass("slick-slider");
          let css = elemento[0]["style"]["cssText"];
          elemento.removeAttr("style");
          elemento.attr("data-style", css);
        } else {
          elemento.parent().parent().addClass("slick-track");

          elemento.removeAttr("style");
          let css = elemento.attr("data-style");
          elemento.attr("style", css);
          elemento.attr("data-style", "");
        }
      }
      _self.fullScreen();
    });
    ...
    _self._playerWrapper
      ...
      .on("click", function (e) {
        ...
        // calc position
        var _pos =
          e.pageX - _self._playerWrapper.find("#progressholder").offset().left;

        var _maxPos =
          _self._playerWrapper.find("#progressholder").width() +
          parseFloat(
            _self._playerWrapper.find("#progressholder").css("padding-right")
          ) +
          parseFloat(
            _self._playerWrapper.find("#progressholder").css("padding-left")
          );
  ...
  vid.prototype.playPauseEvents = function () {
    ...
    if (_self._settings.keyboardControls) {
      ...
      jQuery("body").on("keyup", function (e) {
        if (e.keyCode == 32) {
          if (_self._playerWrapper.hasClass("isFullscreen")) {
            _self._playerWrapper.hasClass("playing")
              ? _self.pause()
              : _self._playerWrapper.hasClass("finished")
              ? _self._settings.allowReplay
  ...
  vid.prototype.play = function () {
    ...
    if (_self._settings.fontAwesomeControlIcons) {
      _self._playerWrapper
        .find("#playPause")
        .html(
          '<span class="FAIcon"><i class="far fa-pause-circle"></i></span>'
        );
    } else {
    ...
    if (
      _self._settings.showControls &&
      (_self._settings.showScrubber || _self._settings.showTimer)
    ) {
      if (_self._settings.vimeo_url) {
  ...
  vid.prototype.pause = function () {
    ...
    if (_self._settings.fontAwesomeControlIcons) {
      _self._playerWrapper
        .find("#playPause")
        .html('<span class="FAIcon"><i class="far fa-play-circle"></i></span>');
    } else {
  ...
  vid.prototype.fullScreen = function () {
    ...
    if (!_self._isFs) {
      if (
        ...
        _self.runPrefixMethod(
          navigator.userAgent.toLowerCase().indexOf("safari") > -1
            ? _self._settings.vimeo_url
              ? _self._video.element
              : _self._video[0]
            : _self._playerWrapper[0],
  ...
  vid.prototype.mute = function (isMuted) {
    ...
    if (isMuted) {
      ...
      _self._element.find(".soundBar").each(function () {
        ...
        if (
          parseFloat(jQuery(this).data("value")) ===
          parseFloat(
            _self._element.find(".vidControls").find(".muteBtn").data("current")
          )
        ) {
          _flag = false;
        }
      ...
      // mute
      if (_self._settings.vimeo_url) {
        _self._player.setVolume(
          parseFloat(
            _self._element.find(".soundBar.active").last().data("value")
          )
        );
      } else {
  ...
  vid.prototype.close = function () {
    ...
    if (_self._settings.playInModal) {
      ...
      jQuery("#" + _self._video.attr("id") + "_modal")
  ...
  vid.prototype.updateProgress = function (_self) {
    _self._playerWrapper
      ...
      .css(
        "width",
        (_self._player.buffered.end(_self._player.buffered.length - 1) /
          _self._player.duration) *
          100 +
          "%"
      );
    _self._playerWrapper
      ...
      .css(
        "width",
        (_self._player.currentTime / _self._player.duration) * 100 + "%"
      );
      ...
      if (typeof dataLayer !== undefined) {
        for (var i in _self._settings.gtmOptions) {
          if (
            Math.floor(
              (_self._player.currentTime / _self._player.duration) * 100
            ) === parseFloat(_self._settings.gtmOptions[i].time)
          ) {
  ...
  vid.prototype.updateVimeoProgress = function (_self, data) {
    ...
    if (_self._settings.gtmTagging) {
      if (typeof dataLayer !== undefined) {
        for (var i in _self._settings.gtmOptions) {
          if (
            Math.floor((data.seconds / data.duration) * 100) ===
            parseFloat(_self._settings.gtmOptions[i].time)
          ) {
            if (!_self.checkTaging(_self._settings.gtmOptions[i].name)) {
              _self.sendTag(_self._settings.gtmOptions[i].type, name);
  ...
  vid.prototype.updateOrb = function (e) {
    ...
    var _maxPos =
      ...
      _self._playerWrapper.find("#progressorb").width() / 2;

    _self._playerWrapper
      .find("#progressorb")
      .css("left", _orbPos > _maxPos ? _maxPos : _orbPos + "px");
  };
  ...
  vid.prototype.videoEnded = function () {
    ...
    _self._playerWrapper
      .removeClass("playing")
      .removeClass("paused")
      .addClass(_self._settings.closeModalOnFinish ? "closing" : "finished")
      .removeClass("hideOverlay")
      .find(".vidControls")
      .addClass("hide");
    clearInterval(_self._progress);
  ...
  vid.prototype.openInModal = function () {
    ...
    _self._playerWrapper
      .parent()
      .appendTo("#" + _self._video.attr("id") + "_modal .videoModalHolder");
  ...
  vid.prototype.createVimeoEmbed = function () {
    ...
    iframe.setAttribute(
      ...
      "https://player.vimeo.com/video/" +
        (_self._settings.vimeo_url.match(regex)
          ? RegExp.$2
          : _self._settings.vimeo_url) +
        "?controls=0"
    );
    ...
    _self._element
      .find(".rtopVideoHolder")
      .addClass("vimeoPlayer")
      .find(".rtopExternalPlayer")
      .append(iframe);
    ...
    if (!jQuery.event.special[object.name].vid) {
      ...
      jQuery.event.special[object.name]._default = function (e) {
        if (
          _default &&
          _default.apply &&
          (!e.namespace || e.namespace.indexOf("vid") === -1)
        ) {
  ...
  jQuery.fn.RTOP_VideoPlayer = function (_option) {
    ...
    return this.each(function () {
      var _this = jQuery(this),
        _data = _this.data("vid.RTOP_VideoPlayer");
      if (!_data) {
